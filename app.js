const I18N = {
  az: {
    ...
    ig_label: "Instagram",
    wa_label: "WhatsApp",
    contact_sub: "Tez cavab üçün WhatsApp-a yazın və ya Instagram-da izləyin.",
    contact_wa: "WhatsApp",
  ...
  ru: {
    ...
    ig_label: "Instagram",
    wa_label: "WhatsApp",
    contact_sub: "Для быстрого ответа напишите в WhatsApp или следите за нами в Instagram.",
    contact_wa: "WhatsApp",
    contact_ig: "Instagram",
    ...
    booking_sub: "Отправьте бронь — мы свяжемся с вами для подтверждения.",
    f_name: "Имя",
    f_phone: "Телефон",
    f_date: "Дата",
    f_time: "Время",
  ...
  en: {
    ...
    ig_label: "Instagram",
    wa_label: "WhatsApp",
    contact_sub: "For a quick reply, message us on WhatsApp or follow us on Instagram.",
    contact_wa: "WhatsApp",
    contact_ig: "Instagram",
